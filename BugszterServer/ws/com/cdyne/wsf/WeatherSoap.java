...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns com.cdyne.wsf.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns com.cdyne.wsf.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns com.cdyne.wsf.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "com.cdyne.wsf.GetCityWeatherByZIPResponse")
